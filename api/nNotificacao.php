<?php 
	...
	$executa->execute();
	$executa2 = $db->prepare("select * from notificaresposta inner join resposta on notificaresposta.resposta = idresposta  inner join pergunta on resposta.pergunta= idpergunta  where remetente=:usuario and visto=0 ");
